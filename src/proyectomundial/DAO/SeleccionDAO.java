...
public class SeleccionDAO {
    ...
    public List<Seleccion> buscarSelecciones(String equipo, String continente, String dt, String nacionalidad) {
        String sql = "SELECT DISTINCT nombre, continente, dt, nacionalidad "
                + "FROM s_rojas9.seleccion WHERE nombre ILIKE '%" + equipo + "%' "
                + "OR continente ILIKE '%" + continente +"%' OR dt ILIKE '%" + dt +"%' "
                + "OR nacionalidad ILIKE '%" + nacionalidad +"%';";
    ...
    public boolean registrarSeleccion(Seleccion seleccion) {
        ...
        String sql = "INSERT INTO s_rojas9.seleccion (nombre, continente, dt, nacionalidad) values("
                + "'" + seleccion.getNombre() + "', " 
    ...
    public List<Seleccion> getSelecciones() {
        ...
        String sql = "SELECT nombre, continente, dt, nacionalidad FROM s_rojas9.seleccion";
        List<Seleccion> selecciones = new ArrayList<Seleccion>();
    ...
    public String[][] getSeleccionesMatriz(String equipo, String continente, String dt, String nacionalidad) {
        
        String[][] matrizSelecciones = null;
        List<Seleccion> selecciones = buscarSelecciones(equipo, continente, dt, nacionalidad);
