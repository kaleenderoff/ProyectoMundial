...
public class GUIManual extends JFrame {
    ...
    public String[][] matrizResultados = null;
    ...
    private void accionSelecciones() {
        ...
        matrizSelecciones = seleccionDAO.getSeleccionesMatriz();

        // Si no hay selecciones cargadas, muestra el botón de carga de selecciones
        if (matrizSelecciones == null) {
            jPanelMain.removeAll();
    ...
    private void accionResultados() {
        ...
        matrizResultados = resultadoDAO.getResultadosMatriz();

        // Si no hay resultados cargados, muestra el botón de carga de resultados
        if (matrizResultados == null) {
            jPanelMain.removeAll();
    ...
    private void accionDashboardSel() {
        //numero de selecciones por continente
        jLabelTop.setText("Dash Selecciones");
        matrizSeleccionesContinente = dashSeleccionesDAO.getSeleccionesPorContinenteMatriz();
    ...
    public void pintarTablaSelecciones() {
        ...
        JTable table = new JTable(matrizSelecciones, columnNames);
        ...
        buscar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                if (field.getText().isEmpty()) {
                    ...
                    matrizSelecciones = seleccionDAO.getSeleccionesMatriz(field.getText(), field.getText(), field.getText(), field.getText());
                    pintarTablaSelecciones();
                }
            }
        });
    ...
    public void cargarFileResultados() {
        ...
        try {
            ...
            matrizResultados = new String[48][7];
            entrada.nextLine();
            ...
            while (entrada.hasNext()) {
                ...
                if (resultadoDAO.registrarResultado(resultado)) {
                    System.out.println("Resultado " + (i + 1) + " registrado");
                } else {
                    System.out.println("Error en el resultado " + i);
                }
    ...
    public void pintarTablaResultados() {
        ...
        JTable table = new JTable(matrizResultados, columnNames);
        table.setRowHeight(30);
        ...
        buscar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                if (field.getText().isEmpty()) {
                    JOptionPane.showMessageDialog(null, "Campo 'Busqueda de Resultados' vacio.");
                } else {
                    matrizResultados = resultadoDAO.getResultadosMatriz(field.getText(), field.getText(), field.getText(), field.getText(), field.getText(), field.getText(), field.getText());
                    pintarTablaResultados();
                }
            }
        });
    ...
    // Resultados Dash Selecciones
    public void pintarDashSelecciones() {
